...
export const mockInventory = [
  ...
  { id: 5, destination: 'Rishikesh', hotel: 'Ganga Kinare', vibe: 'offbeat', pace: 'chill', accommodation: 'hotel', costPerPerson: 7000, dates: 'Dec 19-22', evidence: 'Riverside stays known for yoga and slow mornings',
    riskFlag: 'Seasonal river-level risk on the rafting stretch during this window.',
    riskEvidence: { platform: 'Uttarakhand Tourism Advisory', platformType: 'advisory', quote: '"Water levels on the Shivpuri-Rishikesh rafting stretch fluctuate sharply through late December due to upstream dam release schedules, sometimes suspending rafting for a day or two. Confirm operator status before locking travel dates."', author: 'Uttarakhand Tourism & Disaster Management Dept.' } },
