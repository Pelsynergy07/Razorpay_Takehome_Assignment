    ...
    itinerary: [
      {
        ...
        emoji: '🛬',
        description: 'Arrive via the AC Sleeper Volvo Bus and check into Backpackers Hostel right on the riverfront. Keep the evening light — bonfire and a briefing for the days ahead.',
      ...
      },
      {
        ...
        emoji: '🚣',
        description: 'Shivpuri 16km white water rafting in the morning, a cliff jump at Maggie Point after lunch, and the Triveni Ghat evening aarti to close the day.',
        transportMode: null,
      ...
      },
      {
        ...
        emoji: '🧘',
        description: 'A slower day — a guided riverside yoga session, a pottery workshop, and an evening exploring the cafes around Laxman Jhula.',
        transportMode: null,
      ...
      },
      {
        ...
        emoji: '🌅',
        description: 'One last walk along the ghats before checking out and heading back via the AC Sleeper Volvo Bus.',
        transportMode: 'AC Sleeper Volvo Bus',
        image: null,
        rating: null,
        bookable: ['transport'],
    ...
    itinerary: [
      {
        ...
        emoji: '🛬',
        description: 'Arrive via the direct IndiGo flight into Mopa and settle into Taj Holiday Village. Spend the evening at the palm garden and sunset lounge.',
      ...
      },
      {
        ...
        emoji: '🌅',
        description: 'Walk Palolem and Agonda beaches through the day, then wind down with a Mandovi River sunset cruise.',
        transportMode: null,
      ...
      },
      {
        ...
        emoji: '🤿',
        description: 'A PADI-guided scuba session at Grand Island, followed by a banana ride and jet ski bundle for the afternoon.',
        transportMode: null,
      ...
      },
      {
        ...
        emoji: '🌴',
        description: 'One last swim before checking out and heading back on the direct flight home.',
        transportMode: 'Direct Flight (IndiGo)',
        image: null,
        rating: null,
        bookable: ['transport'],
